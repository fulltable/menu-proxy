...
app.get('/api/restaurants/:id/menus', (req, res) => {
  axios3004
    .get(`/api/restaurants/${req.params.id}/menus`)
...
//   axios3004
//     .get(`/api/restaurants/${req.params.id}/menus/${req.params.menu}`)
//     .then(response => res.send(response.data))
//     .catch(error => res.send(error));
// });
...
//   axios3003
//     .get(`/api/restaurants/${req.params.id}/info`)
//     .then(response => res.send(response.data))
//     .catch(error => res.send(error));
// });
...
//   axios3003
//     .get(`/api/restaurants/${req.params.id}/overview`)
//     .then(response => res.send(response.data))
//     .catch(error => res.send(error));
// });
...
//   axios3002
//     .get(`/api/restaurants/${req.params.id}/photos`)
//     .then(response => res.send(response.data))
//     .catch(error => res.send(error));
// });
...
//   axios3001
//     .get(`/api/restaurants/${req.params.id}/reviews`)
//     .then(response => res.send(response.data))
//     .catch(error => res.send(error));
// });
